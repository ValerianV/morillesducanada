      ...
      <div className="container mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-foreground/70 font-light mt-6 max-w-xl mx-auto">Chaque photo a été prise sur les zones de cueillette, dans les forêts brûlées de Colombie-Britannique et du Yukon.
