  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h1
          className="font-serif text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-light leading-tight mb-6 md:mb-8"
        ...
        <motion.p
          className="text-lg md:text-xl text-secondary-foreground/80 font-light max-w-2xl mx-auto mb-12 leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.8 }}
        >
          Nées des cendres des forêts boréales, nos morilles sauvages offrent un
          arôme fumé et une intensité incomparables. Un trésor rare, séché avec
          soin pour les palais les plus exigeants.
        </motion.p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
          >
            <span className="relative z-10">Découvrir nos morilles</span>
            <motion.div
      ...
      >
        <motion.div
          className="w-px h-16 bg-gradient-to-b from-primary/60 to-transparent mx-auto"
