export const en = {
  ...
  about: {
    ...
    p2: "Three years in this trade opened my eyes: between the foragers who risk everything in the field and the customers who pay top price, there's a missing link. I decided to create it. Today, I buy my morels <strong>directly from the foragers</strong> I worked alongside — people I now consider friends and trust completely. No wholesaler, no middleman — just a short, honest supply chain.",
    p3: "<strong>Morilles du Canada</strong> is a tiny business born from this adventure. A handful of trusted foragers, careful drying, and the desire to bring France the most precious gift of the boreal forests. Every jar, every pouch has a story — and I want to share it with you.",
