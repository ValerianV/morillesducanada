export const fr = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Livrez-vous en dehors de la France ?", a: "Oui, nous livrons dans toute l'Union Européenne. Les frais de livraison et délais varient selon la destination. Contactez-nous pour un devis personnalisé pour les commandes hors France." },
