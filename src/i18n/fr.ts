export const fr = {
  ...
  about: {
    ...
    p2: "Trois ans dans ce métier m'ont ouvert les yeux : entre les cueilleurs qui risquent tout sur le terrain et les clients qui paient le prix fort, il manque un lien juste. J'ai décidé de le créer. Aujourd'hui, j'achète mes morilles <strong>directement auprès des cueilleurs</strong> que j'ai côtoyés, que je considère comme des amis et des gens de confiance. Pas de grossiste, pas d'intermédiaire — juste un circuit court, honnête.",
    p3: "<strong>Morilles du Canada</strong>, c'est une toute petite entreprise née de cette aventure. Une poignée de cueilleurs de confiance, un séchage soigné, et l'envie de faire découvrir en France ce que les forêts boréales ont de plus précieux. Chaque pot, chaque sachet a une histoire — et j'ai envie de vous la raconter.",
