...
const faqItems = [
  {
    ...
    a: "Oui, contactez-nous dans l'heure suivant votre commande à contact@morillesducanada.fr et nous ferons le nécessaire.",
  },
  {
              ...
              <div className="bg-card border border-border rounded-lg p-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-secondary-foreground/70 font-light leading-relaxed">
                    ...
                    <a
                      href="mailto:contact@morillesducanada.fr"
                      className="text-primary hover:text-gold-light transition-colors"
                    >
                      contact@morillesducanada.fr
                    </a>{" "}
