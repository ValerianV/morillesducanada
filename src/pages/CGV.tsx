        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-10 text-sm text-secondary-foreground/80 font-light leading-relaxed">
            ...
            <section>
              ...
              <p>
                Toute réclamation doit être adressée par email à <strong className="text-foreground">contact@morillesducanada.fr</strong> dans un délai de 14 jours suivant la réception du produit, accompagnée de photos le cas échéant.
              </p>
            </section>
